...
--SPOTLIGHT
if not lowQuality then
	makeLuaSprite('spotlight1', 'spotlight', -4200, -2020);
	setScrollFactor('spotlight1', 1, 1);
    scaleObject('spotlight1', 4.5, 5);
